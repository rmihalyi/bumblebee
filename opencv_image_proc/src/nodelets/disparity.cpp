...
#include <opencv_image_proc/DisparityConfig.h>
...
class DisparityNodelet : public nodelet::Nodelet
{
  ...
  typedef opencv_image_proc::DisparityConfig Config;
...
PLUGINLIB_DECLARE_CLASS(opencv_image_proc, disparity,
                        opencv_image_proc::DisparityNodelet, nodelet::Nodelet)
